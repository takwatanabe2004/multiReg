function [ labels ] = mc_NearestNetworkNode(refimage,voxlist, radius)
...
%=========================================================================%
% tak: modified this from slabWork
% (05/29/2014)
%=========================================================================%
%%
%% Get the space
%%% tak: 07/06/2013: this part modified %%%
% refimage='/net/data4/MAS/ROIS/Yeo/YeoPlus.hdr';
% refimage=[fileparts(which('tinit.m')),'/Data_local/Yeo/YeoPlus.hdr'];
