%% june29_plot_timeSeries_roiTC_hierarchical
% (06/29/2014)
%=========================================================================%
...
% - "hierarchical" in the sense that i box the z-structure and the inner
%   y-structure... (run the script to see what i mean)
%=========================================================================%
%%
clear all;
purge
