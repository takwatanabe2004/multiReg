...
fsave=true;
outPath = [get_rootdir,'/data_local/connectome_info_347roi/graph_info347.mat'];
outVars={'adjmat', 'coord', 'roiMNI', 'roiMNI_flipx', 'timeStamp', 'timeTotal', 'mFileName'};
%%
d=347;
p=nchoosek(d,2);

load([get_rootdir,'/data_local/connectome_info_347roi/yeo_info347.mat'],...
    'yeoLabels', 'roiMNI', 'roiLabel')
