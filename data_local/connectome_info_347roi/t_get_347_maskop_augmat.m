...
outPath = [get_rootdir,'/data_local/connectome_info_347roi/augmat_mask347.mat'];
outVars={'b', 'A', 'timeStamp',  'mFileName'};
%% this cell block is mostly identical to t_get_347_maskop_augmat.m
load([get_rootdir,'/data_local/connectome_info_347roi/graph_info347.mat'],...
    'adjmat','coord');
% randn('state',0)
d=coord.nsamp;
p=d*(d-1)/2;
