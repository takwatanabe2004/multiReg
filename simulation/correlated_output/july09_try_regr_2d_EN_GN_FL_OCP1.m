%% july09_try_regr_2d_EN_GN_FL_OCP1.m
% (07/09/2014)
%=========================================================================%
...
load([rootdir,'/correlatedWeight_july09_2d_smooth2.mat'],'W','idxCluster','dict','nx','ny')
% load([rootdir,'/correlatedWeight_july09_2d_patch2.mat'],'W','idxCluster','dict','nx','ny')
[p,q]=size(W);
%% make data
n=1200;
ntest=100;
...
%-------------------------------------------------------------------------%
outputAdjmat = (Ycorr_abs>(0.4)).*Ycorr;
...
k=2;
figure,imexp
subplot(241),imcov(reshape(W(:,idxCluster{1}(k)), [nx,ny]) ,1), mytitle('Truth'),CAXIS1=caxis;
subplot(242),imcov(reshape(W(:,idxCluster{2}(k)), [nx,ny]) ,1),CAXIS2=caxis;
subplot(243),imcov(reshape(W(:,idxCluster{3}(k)), [nx,ny]) ,1),CAXIS3=caxis;
subplot(244),imcov(reshape(W(:,idxCluster{4}(k)), [nx,ny]) ,1),CAXIS4=caxis;
subplot(245),imcov(reshape(W(:,idxCluster{1}(k)), [nx,ny]) ,1), mytitle('Truth'),CAXIS1=caxis;
subplot(246),imcov(reshape(W(:,idxCluster{2}(k)), [nx,ny]) ,1),CAXIS2=caxis;
subplot(247),imcov(reshape(W(:,idxCluster{3}(k)), [nx,ny]) ,1),CAXIS3=caxis;
subplot(248),imcov(reshape(W(:,idxCluster{4}(k)), [nx,ny]) ,1),CAXIS4=caxis;
%-------------------------------------------------------------------------%
% EN
%-------------------------------------------------------------------------%
figure,imexp
subplot(241),imcov(reshape(West.EN(:,idxCluster{1}(k)), [nx,ny]) ,1), mytitle('EN'),caxis(CAXIS1)
subplot(242),imcov(reshape(West.EN(:,idxCluster{2}(k)), [nx,ny]) ,1),caxis(CAXIS2)
subplot(243),imcov(reshape(West.EN(:,idxCluster{3}(k)), [nx,ny]) ,1),caxis(CAXIS3)
subplot(244),imcov(reshape(West.EN(:,idxCluster{4}(k)), [nx,ny]) ,1),caxis(CAXIS4)
subplot(245),imcov(reshape(West.EN_OCP1(:,idxCluster{1}(k)), [nx,ny]) ,1), mytitle('EN_OCP1'),caxis(CAXIS1)
subplot(246),imcov(reshape(West.EN_OCP1(:,idxCluster{2}(k)), [nx,ny]) ,1),caxis(CAXIS2)
subplot(247),imcov(reshape(West.EN_OCP1(:,idxCluster{3}(k)), [nx,ny]) ,1),caxis(CAXIS3)
subplot(248),imcov(reshape(West.EN_OCP1(:,idxCluster{4}(k)), [nx,ny]) ,1),caxis(CAXIS4)
%-------------------------------------------------------------------------%
% GN
%-------------------------------------------------------------------------%
figure,imexp
subplot(241),imcov(reshape(West.GN(:,idxCluster{1}(k)), [nx,ny]) ,1), mytitle('GN'),caxis(CAXIS1)
subplot(242),imcov(reshape(West.GN(:,idxCluster{2}(k)), [nx,ny]) ,1),caxis(CAXIS2)
subplot(243),imcov(reshape(West.GN(:,idxCluster{3}(k)), [nx,ny]) ,1),caxis(CAXIS3)
subplot(244),imcov(reshape(West.GN(:,idxCluster{4}(k)), [nx,ny]) ,1),caxis(CAXIS4)
subplot(245),imcov(reshape(West.GN_OCP1(:,idxCluster{1}(k)), [nx,ny]) ,1), mytitle('GN_OCP1'),caxis(CAXIS1)
subplot(246),imcov(reshape(West.GN_OCP1(:,idxCluster{2}(k)), [nx,ny]) ,1),caxis(CAXIS2)
subplot(247),imcov(reshape(West.GN_OCP1(:,idxCluster{3}(k)), [nx,ny]) ,1),caxis(CAXIS3)
subplot(248),imcov(reshape(West.GN_OCP1(:,idxCluster{4}(k)), [nx,ny]) ,1),caxis(CAXIS4)
%-------------------------------------------------------------------------%
% FL
%-------------------------------------------------------------------------%
figure,imexp
subplot(241),imcov(reshape(West.FL(:,idxCluster{1}(k)), [nx,ny]) ,1), mytitle('FL'),caxis(CAXIS1)
subplot(242),imcov(reshape(West.FL(:,idxCluster{2}(k)), [nx,ny]) ,1),caxis(CAXIS2)
subplot(243),imcov(reshape(West.FL(:,idxCluster{3}(k)), [nx,ny]) ,1),caxis(CAXIS3)
subplot(244),imcov(reshape(West.FL(:,idxCluster{4}(k)), [nx,ny]) ,1),caxis(CAXIS4)
subplot(245),imcov(reshape(West.FL_OCP1(:,idxCluster{1}(k)), [nx,ny]) ,1), mytitle('FL_OCP1'),caxis(CAXIS1)
subplot(246),imcov(reshape(West.FL_OCP1(:,idxCluster{2}(k)), [nx,ny]) ,1),caxis(CAXIS2)
subplot(247),imcov(reshape(West.FL_OCP1(:,idxCluster{3}(k)), [nx,ny]) ,1),caxis(CAXIS3)
subplot(248),imcov(reshape(West.FL_OCP1(:,idxCluster{4}(k)), [nx,ny]) ,1),caxis(CAXIS4)