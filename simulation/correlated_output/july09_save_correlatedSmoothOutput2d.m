%% july09_save_correlatedSmoothOutput2d.m
% (07/09/2014)
%=========================================================================%
...
%         D(:,id) = tak_sim_assignPatch2d(NSIZE,nPatches,pulseLenBase)/20;        
        D(:,id) = tak_sim_assignPulse2d(NSIZE,nPatches)/20;        
    end
...
% save([rootdir,'/correlatedWeight_july09_2d_smooth2.mat'],'W','idxCluster','dict','nx','ny','mFileName','timeStamp')
