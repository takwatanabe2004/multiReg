%% june30_view_MNI_node_coverage_sliceBYslice_YeoColored.m
% (06/30/2014)
%=========================================================================%
...
% yeoLabels
% load('C:\Users\takanori\Documents\MATLAB\BNV_repos\BrainNetViewer\Data\Brain_AAL_Nodes_Edges_edited.mat')
...
for x=1:coord.nx
    ...
    tak_plot_sim_nodes2d_subplots_yeo(H,ny,nz,xslice,cnt,roiLabel,yeoColors)
...
for y=1:coord.ny
    ...
    tak_plot_sim_nodes2d_subplots_yeo(H,nx,nz,yslice,cnt,roiLabel,yeoColors)
...
for z=1:coord.nz
    ...
    tak_plot_sim_nodes2d_subplots_yeo(H,nx,ny,zslice,cnt,roiLabel,yeoColors)
