function tak_plot_sim_nodes2d_subplots3(H,nx,ny,idx_anom,counter)
% (06/30/2014)
%-------------------------------------------------------------------------%
% added a "counter" representing the lexicographic index of the nodes
% (run june30_view_MNI_node_coverage_sliceBYslice_withIndices.m)
%=========================================================================%
...
if nargin==5 && size(idx_anom,1)==1
    % show red seeds
%     [ix,iy]= ind2sub([nx,ny],idx_anom);         
%     plot(ix,iy,markerOption{:},'MarkerFaceColor', color_blue)    
