function [w,idx_supp,supp_info,C] = tak_sim_weight_4d_quadpartite(nx,ny)
...
idx_anom2 = [174:179, 189:194, 204:209];

% 3rd cluster
idx_anom3 = [25:29, 40:44, 55:59, 70:74];

% 4th cluster
idx_anom4 = [122:126, 108:110, 94, 138:140, 154]+(4*ny);

supp_info.idx_anom = [idx_anom1, idx_anom2, idx_anom3, idx_anom4];
...
% 2-3
supp_info.idx_list{4,1}=tak_nodes2edges_2clusters(nx,ny,idx_anom2,idx_anom3);
supp_info.idx_list{4,2}='2-3';

% 2-4
supp_info.idx_list{5,1}=tak_nodes2edges_2clusters(nx,ny,idx_anom2,idx_anom4);
supp_info.idx_list{5,2}='2-4';

% 3-4
supp_info.idx_list{6,1}=tak_nodes2edges_2clusters(nx,ny,idx_anom3,idx_anom4);
supp_info.idx_list{6,2}='3-4';
