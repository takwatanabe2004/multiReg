function [W,output]=tak_EN_regr_MTL_ISTA(X,Y,lam,gam,options,wtrue)
% [w,output]=tak_EN_regre_MTL_ISTA(X,y,lam,gam,options,wtrue)
% (06/20/2014)
%=========================================================================%
% - ISTA elastic net regression - MTL:
...
%     W = soft(W - tau*GRAD(W), lam*tau);
    W = tsoftvec(W - tau*GRAD(W),lam*tau);
%     keyboard
