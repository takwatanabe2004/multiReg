function imconnYeor(w,GRID,flagCmap,flagLineText)
% imconnYeor(w,GRID,flagCmap,flagLineText)
%=========================================================================%
...
% flagCmap: "symmetrize" the colormap scale (default: off)
...
if ~exist('flagCmap','var') || isempty(flagCmap)
    flagCmap = 0;
end
...
textOption={'fontweight','b','fontsize',9};
...
imcov(wmat), axis off,%colorbar off
